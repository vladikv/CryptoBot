...
async def data(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        await update.message.reply_text("Please provide a correct cryptocurrency name.")
...
async def high_low(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        logger.error(f"Error in high_low command: {e}")
        await update.message.reply_text("An error occurred while processing your request.")
...
async def supply(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        logger.error(f"Error in supply command: {e}")
        await update.message.reply_text("An error occurred while processing your request.")
...
async def search_pools(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        ...
        await update.message.reply_text("Please provide query parameters.")
    except Exception as e:
        logger.error(f"Error in search_pools command: {e}")
        await update.message.reply_text("An error occurred while processing your request.")

async def help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        help_message = ('/data <crypto-name> - command to get the data of a cryptocurrency\n'
                        '/high_low <crypto-name> - command to get the highest and lowest prices of a cryptocurrency in the last 24 hours\n'
                        '/supply <crypto-name> - command to get the circulating supply and total supply of a cryptocurrency\n'
